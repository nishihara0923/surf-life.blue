...
false,
$name = 'おすすめの投稿',
array( 'description' => '投稿で選択したおすすめの投稿を表示', )
);
}
...
echo $before_widget;
if( $title ){echo $before_title . $title . $after_title;}else{echo $before_title . 'おすすめの投稿' . $after_title;}
?>
<?php 
...
?>
<?php 
$args = Array('post_type' => 'post','posts_per_page' => wp_filter_nohtml_kses($instance['limit']),'meta_key' => 'recommend',);
...
<div class="new-post-img<?php echo wp_filter_nohtml_kses($show_position);?>">
<?php if( has_post_thumbnail() ): ?>
<a href="<?php the_permalink(); ?>"><?php esc_url(the_post_thumbnail($show_shape)); ?></a>
<?php else: ?>
<a href="<?php the_permalink(); ?>"><img src="<?php bloginfo('template_url'); ?>/img/no-<?php echo $show_shape ?>.png" alt="no-image"></a>
<?php endif; ?>

<?php if($show_view):?>
<div class="list-post-view">
<span class="post-view-count"><?php echo number_format((int)esc_html(get_post_meta(get_the_ID(),"view",true))); ?></span> <span class="post-views">views</span>
</div>
<?php endif; ?>
</div>   
...
<?php echo number_format((int)esc_html(get_post_meta(get_the_ID(),"view",true))); ?> views</span><?php endif; ?>
<?php if($show_comments):?>
<span class="list-category-comments"><?php echo number_format(get_comments_number()); ?> 件</span>
<?php endif; ?>
<?php if($show_author):?>
...
<?php echo $after_widget;}}register_widget('recommend_Widget');?>