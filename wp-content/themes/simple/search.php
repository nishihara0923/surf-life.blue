...
<h1><?php 
if($search_title == '全ての一覧'){echo '全ての一覧';;}else{echo "「".$search_title.'」<span class="search-results-text">に関する検索結果</span>';}
...
<?php if($original_site['list_option3'] && get_post_type() == 'post' ):?>
...
<span class="list-category-author"><?php the_author_posts_link(); ?></span><?php endif; ?>
</p>
<?php endif; ?>
...
<!-- 記事が存在しない場合 -->
<div class="page-404">
<p class="page-404-top">ページが見つかりませんでした。</p>
