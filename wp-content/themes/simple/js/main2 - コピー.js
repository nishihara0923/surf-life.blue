...
if(windowWidths != wws) {
var widthwindow_resize = window.innerWidth || document.documentElement.clientWidth || document.body.clientWidth;
...
$(".categories .accordion").css({width: $(".categories2").width()+100});
